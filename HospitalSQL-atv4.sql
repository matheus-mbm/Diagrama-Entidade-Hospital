...
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '1';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '2';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '3';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '4';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '5';
UPDATE medico SET em_atividade = 'Inativo' WHERE id = '6';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '7';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '8';
UPDATE medico SET em_atividade = 'Inativo' WHERE id = '9';
UPDATE medico SET em_atividade = 'Ativo' WHERE id = '10';
